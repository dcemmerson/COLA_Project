...
import * as aa from './account_ajax.js';
...
async function updatePassword() {
    try {
        ...
        let context = await aa.submitPassword();

        utility.hideElements($('.changePasswordAlert'));
...
function updateLengthValidationMark(field, req, submit) {
    let validPassword = true;
    if (submit){
	utility.clearInnerText(document.getElementsByClassName('passwordError'));
    }
