...
import * as ca from './createAccount_ajax.js';
...
async function createAccount() {
    try {
        ...
        utility.disableForm(document.getElementById('changePasswordForm'));
        removeServerErrors();

        utility.showSpinner(document.getElementById('submitBtnDiv'));
        var context = await ca.submitCredentials();
        ...
        if (!context || !context.success) {
            ...
            utility.enableForm(document.getElementById('changePasswordForm'));
        }
    }
}
...
function updateLengthValidationMark(field, req, submit) {
    let validPassword = true;
    if (submit) utility.clearInnerText(document.getElementsByClassName('passwordError'));
